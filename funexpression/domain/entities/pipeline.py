...
class Pipeline:
    ...
    def from_json(json: dict):
        return Pipeline(
            ...
            control_organism=Triplicate(
                srr_1=SRAFile(
                    acession_number=json["control_organism"]["ssr_1"][
                        "acession_number"
                    ],
                    status=SRAFileStatusEnum[
                        json["control_organism"]["ssr_1"]["status"]
                    ],
                ),
                srr_2=SRAFile(
                    acession_number=json["control_organism"]["ssr_2"][
                        "acession_number"
                    ],
                    status=SRAFileStatusEnum[
                        json["control_organism"]["ssr_2"]["status"]
                    ],
                ),
                srr_3=SRAFile(
                    acession_number=json["control_organism"]["ssr_3"][
                        "acession_number"
                    ],
                    status=SRAFileStatusEnum[
                        json["control_organism"]["ssr_3"]["status"]
                    ],
                ),
            ),
            experiment_organism=Triplicate(
                srr_1=SRAFile(
                    acession_number=json["experiment_organism"]["ssr_1"][
                        "acession_number"
                    ],
                    status=SRAFileStatusEnum[
                        json["experiment_organism"]["ssr_1"]["status"]
                    ],
                ),
                srr_2=SRAFile(
                    acession_number=json["experiment_organism"]["ssr_2"][
                        "acession_number"
                    ],
                    status=SRAFileStatusEnum[
                        json["experiment_organism"]["ssr_2"]["status"]
                    ],
                ),
                srr_3=SRAFile(
                    acession_number=json["experiment_organism"]["ssr_3"][
                        "acession_number"
                    ],
                    status=SRAFileStatusEnum[
                        json["experiment_organism"]["ssr_3"]["status"]
                    ],
                ),
            ),
